...
import com.buildpackage.fields.FieldInfo;
...
public class MsgUtils {
     ...
     * @throws Exception
     */
    public static Header_STD parse8583MsgHeader(String msg, int [] pHeader) throws Exception {
     ...
     */
    @Deprecated
    public static Header_STD parse8583MsgHeader(String msg) throws Exception {//com.buildpackage.fields.F_01
        //Class headerClass = Class.forName("pos2.model.Header_STD");
        Class headerClass = Class.forName("com.buildpackage.model.Header_STD");
        Object header = headerClass.newInstance();
        Method headerMethods[] = headerClass.getMethods();
        List<Method> headMethodList = getRightMethodList(headerMethods, "setmF");//从方法列表中获取带有setmF的方法名
        int curPosition = 0;
        for (int i = 1; i <= 5; i++) {
            ...
            //Class filedClass = Class.forName("pos2.fields.F_" + StringUtils.formatStr(i, "00"));
            Class filedClass = Class.forName("com.buildpackage.fields.F_" + StringUtils.formatStr(i, "00"));
    ...
    public static Body_STD parse8583MsgBody(Header_STD header, String msgData)
        ...
        Class bodyClass = Class.forName("com.buildpackage.model.Body_STD");
        ...
        for (int i = 1; i < fieldChars.length; i++) {
            if (fieldChars[i] != '0') {
                try {
                    ...
                    Class filedClass = Class.forName("com.buildpackage.fields.F" + StringUtils.formatStr(i + 1, "00"));
                    Object filedObj = filedClass.newInstance();
