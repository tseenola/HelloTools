    ...
    /*public static String getEncryptionData(int keyIndex, String[] datas) {
        ...
        for(int i = 0; i < (bcdSens.length / 8); ++i) {
            ...
            int iRet = Ped.Urovo_PciDes(Constants.KEY_TYPE._MACKEY,
                    Integer.parseInt(ConfigUtil.getParamValue(keyIndex, "iMACKIndex")),
