...
public class InitParamPrt extends BaseDealPrt implements IInitParamPrt {
    ...
    public void actionInitParaDown() {
        ...
        lIcParamReq.actionDeal(mContext, "49.4.175.10", 5005, 100, "6000080000", "0800", "03,41,42,60", lAidDownLoadReq, new BaseReq.ResultListener() {
            @Override
            public void succ(Body_STD pBody_std) {
        ...
        *//**
        ...
        lCAPKDownReq.actionDeal(mContext, "49.4.175.10", 5005, 100, "6000080000", "0800", "03,41,42,60", lAidDownLoadReq, new BaseReq.ResultListener() {
            @Override
            public void succ(Body_STD pBody_std) {
                Log.i("vbvb","公钥下载成功");
                pBody_std.show();
