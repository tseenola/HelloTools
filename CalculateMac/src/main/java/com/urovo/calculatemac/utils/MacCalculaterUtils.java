...
public class MacCalculaterUtils {
     ...
     * @param pIMacCalculater mac算法类，执行具体的mac计算，目前已经提供了一个默认mac算法（com.urovo.calculatemac.MacDefCalculater）
     *                        如果有自己的mac算法，请实现接口（com.urovo.calculatemac.IMacCalculater）
